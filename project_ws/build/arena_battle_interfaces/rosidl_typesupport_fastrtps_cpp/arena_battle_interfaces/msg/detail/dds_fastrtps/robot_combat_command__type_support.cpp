...
#include "arena_battle_interfaces/msg/detail/robot_combat_command__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = arena_battle_interfaces::msg::RobotCombatCommand;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const arena_battle_interfaces::msg::RobotCombatCommand *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<arena_battle_interfaces::msg::RobotCombatCommand *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _RobotCombatCommand__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const arena_battle_interfaces::msg::RobotCombatCommand *>(
...
static size_t _RobotCombatCommand__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_RobotCombatCommand(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _RobotCombatCommand__callbacks = {
...
static rosidl_message_type_support_t _RobotCombatCommand__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_RobotCombatCommand__callbacks,
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_arena_battle_interfaces
const rosidl_message_type_support_t *
get_message_type_support_handle<arena_battle_interfaces::msg::RobotCombatCommand>()
{
  return &arena_battle_interfaces::msg::typesupport_fastrtps_cpp::_RobotCombatCommand__handle;
}
